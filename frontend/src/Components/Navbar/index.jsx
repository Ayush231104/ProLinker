...
export default function NavBarComponent() {
  ...
  return (
    <div className="px-5 py-3 shadow-lg w-full">
      <nav className="flex items-center justify-between lg:mx-40 pr-5">
        <div className="flex gap-5">
          ...
          <div className="relative w-64" ref={inputRef}>
            <svg
              ...
              viewBox="0 0 24 24"
              fill="currentColor"
              className="absolute left-3 top-1/2 -translate-y-1/2 size-6 text-gray-400 pointer-events-none"
            >
              <path
                fillRule="evenodd"
            ...
            <input
              ...
              className="w-full p-2 pl-12 border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-400"
            />
