...
import { deletePost, getAllComments, getAllPosts, incrementPostLike } from '../../config/redux/action/postAction';
...
export default function ProfilePage() {
  ...
  const [showFull, setShowFull] = useState(false);
    ...
    const [educationData, setEductionData] = useState({school: "", degree: "", fieldOfStudy: ""})
    ...
    const updateProfilePicture = async (file) => {
      ...
      const response = await clientServer.post("/update_profile_picture", formData, {  //const response = after removing this it steel work
        headers: {
  ...
  return (
    <UserLayout>
      <div className="bg-gray-200 flex gap-3 lg:px-45 pt-3">
                    ...
                    <div className="">
                      ...
                      <div className="">
                        <div className="p-5 pt-15">
                          <div className="">
                            <div style={{flex:"0.8" }}>
                              <div style={{display:"flex", width:"fit-content", gap:"0.2rem"}} className='flex-col'>
                                <input type="text" className={styles.nameEdit} value={userProfile.userId.name}
                                onChange={(e) => {
                                  setUserProfile({...userProfile, userId: {...userProfile.userId, name: e.target.value}})
                                }}/>
                                <p className='text-gray-500'>@{userProfile.userId.username}</p>
                              </div>
        
                              <div>
                                <textarea name="text" value={userProfile.bio}
                                onChange={(e) => {
                      ...
                      <div className="px-5">
                        ...
                        <div className={styles.workHistoryContainer}>
                          ...
                          <button className={`${styles.addWorkButton} h-[50px] shadow-lg mt-4 bg-blue-700 hover:bg-blue-900 text-white font-semibold `}
                          onClick={() => {
                            setIsModalOpen(true)
                          }}
                          >Add Work</button>
                  ...
                  }
                  {
                    ...
                    className={styles.commentsContainer}>
                      <div
                        ...
                        className={styles.allCommentsContainer}>
                          <input onChange={handleEducationInputChange} name='school' className={styles.inputField} type="text" placeholder="Enter Collage Name"/>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 p-2 rounded-lg">
                          {userPosts.map((post) => {
                            return (
                              ...
                              //   </div>
                              // </div>
                               <div key={post._id} className="bg-white rounded-lg shadow-xl border border-gray-300">
          ...
          <div className='bg-gray-200 flex flex-3/10 w-full justify-center'>
