                    ...
                    <div className={styles.scrollComponent}>
                        ...
                        <div className={styles.wrapper}>
                            <div className={styles.createPostContainer}>
                                ...
                                <textarea onChange={(e) => setPostContent(e.target.value)} value={postContent} placeholder={"What's in your mind?"} className={styles.textareaOfFeed} name="text" id=""></textarea>
                                            ...
                                            <div className={styles.singleCard_profileContainer}>
                                                ...
                                                <div>
                                                    ...
                                                    <p style={{ paddingTop: "0.3rem" }}>
                                                        {showFull ? post.body : `${post.body.slice(0, 100)}${post.body.length > 100 ? '...' : ''}`}
                                                        {post.body.length > 100 && (
                                                            <button 
                                                                onClick={() => setShowFull(!showFull)} 
                                                                style={{ marginLeft: '0.5rem', color: 'blue', background: 'none', border: 'none', cursor: 'pointer' }}
                                                            >
                                                    ...
                                                    <div className={styles.optionsContainer}>
                                                        ...
                                                        <div onClick={() => {
                                                            ...
                                                            const url = encodeURIComponent("apanacolage.in");
